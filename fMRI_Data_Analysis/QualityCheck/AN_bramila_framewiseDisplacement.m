function [fwd,rms] = AN_bramila_framewiseDisplacement(cfg)
...
%   - Usage:
%   fwd = AN_bramila_framewiseDisplacement(cfg)
%   - Input:
...
%	Last edit: AN July 2023
    ...
    ts=AN_bramila_detrend(temp_cfg);   % demean and detrend as specified in Power et al 2014
