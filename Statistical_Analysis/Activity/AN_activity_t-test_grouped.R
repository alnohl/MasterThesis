...
beta_WB_nooutliers %>% shapiro_test(differences) 
beta_WF_nooutliers %>% shapiro_test(differences)
beta_FB_nooutliers %>% shapiro_test(differences) 
beta_FW_nooutliers %>% shapiro_test(differences)
...
combined_summaries_nooutliers <- rbind(
  ...
  data.frame(ANOVA = "FacesVsBaseline", stat.testFB_nooutliers, row.names = NULL),
  data.frame(ANOVA = "FacesVsWords", stat.testFW_nooutliers, row.names = NULL)
)


# Save the combined summaries to a CSV file
write.csv(combined_summaries_nooutliers, file = "/Users/alexandranohl/Documents/MSc IDB/Master thesis/Projects/Localizer/MRI Data Analysis/Analysis_children/Statistical_analysis/Hypotheses Analysis/H2.2 Activation VWFA FFA Lateralization/one-sided t-test grouped/t-test_grouped_summary.csv", row.names = FALSE)
...
# Save the combined summaries to a CSV file
write.csv(combined_effectsize_nooutliers, file = "/Users/alexandranohl/Documents/MSc IDB/Master thesis/Projects/Localizer/MRI Data Analysis/Analysis_children/Statistical_analysis/Hypotheses Analysis/H2.2 Activation VWFA FFA Lateralization/one-sided t-test grouped/t-test_grouped_effect_size.csv", row.names = FALSE)
